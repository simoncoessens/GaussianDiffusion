...
FILE_TAG = f"SPRITES_MHA_{NUM_HEADS}h_{NUM_BLOCKS}blocks_{T}ts_mha_classic_lr_bigger"
...
RESUME_CHECKPOINT = "/gpfs/workdir/coessenss/gsplat/src/models/Sprites/SPRITES_MHA_128h_16blocks_200ts_mha_classic/last_SPRITES_MHA_128h_16blocks_200ts_mha_classic_e100_ts200_mse_std_scaled.pth"

# Define the wandb run id to resume the same run (set this to your existing run id)
WANDB_RUN_ID = "dej1xvrv"
