...
from models.param_aware_transformer import ParameterAwareGaussianTransformer
...
FILE_TAG = f"PA_MHA_CIFAR_{NUM_HEADS}h_{NUM_BLOCKS}blocks_{T}ts"
...
def main():
    ...
    if RESUME_TRAINING and os.path.exists(RESUME_CHECKPOINT):
        wandb.init(project='CIFAR_PA_MHA',
