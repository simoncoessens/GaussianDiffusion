...
# from transformer_model_bias import GaussianTransformer
...
DATA_FOLDER = "/gpfs/workdir/coessenss/gsplat/Sprites/gaussian_representations_sprites_downsampled.h5"
...
if __name__ == "__main__":
    ...
    # Load Model
    # model_path = "/gpfs/workdir/coessenss/gsplat/models/sprites_MHA_64h_norm_e100_ts200_mse_std_scaled.pth"
    # model_path = "/gpfs/workdir/coessenss/gsplat/models/sprites_MHA_64h_old_param/val_best_sprites_MHA_64h_old_parm_e100_ts200_mse_std_scaled.pth"
    # model_path = "/gpfs/workdir/coessenss/gsplat/models/sprites_MHA_64h_norm_e100_ts300_mse_std_scaled.pth"
    # model_path = "/gpfs/workdir/coessenss/gsplat/models/sprites_MHA_64h_downsampled/epoch_1_last_sprites_MHA_64h_new_parm_e100_ts200_mse_std_scaled.pth"
    # model_path = "/gpfs/workdir/coessenss/gsplat/models/sprites_MHA_64h_32_blocks_downsampled/val_best_sprites_MHA_64h_32_blocks_new_parm_e100_ts200_mse_std_scaled.pth"
    # model_path = "/gpfs/workdir/coessenss/gsplat/models/sprites_MHA_64h_32_blocks_downsampled_old_param/val_best_sprites_MHA_64h_32_blocks_old_parm_e100_ts200_mse_std_scaled.pth"
    model_path = "/gpfs/workdir/coessenss/gsplat/models/sprites_MHA_64h_22_blocks_mlp_updated/val_best_sprites_MHA_64h_22_blocks_mlp_updated_e100_ts200_mse_std_scaled.pth"
    ...
    n_sample = 100
    size = (100, 9)  # Shape of the Gaussian representation
    ...
    final_latents = x_history[-1]  # Shape: (100, 100, 9)
    
    output_folder = f"Metrics/sprites/sprites_MHA_64h_22_blocks_mlp_updated"
    ...
    for idx in range(n_sample):
        ...
        # Get the i-th latent sample (shape: (100, 9))
    ...
    for i, ax in enumerate(axes.flatten()):
        ...
        img_np = img_tensor.permute(1, 2, 0).numpy()  # shape: (64, 64, 3)
        ax.imshow(img_np)
    ...
    grid_path = os.path.join(output_folder, f"grid_MHA_64h_32_blocks_ts_{num_timestamps}_samples_{n_sample}.png")
