...
class InitialProjection(nn.Module):
    def __init__(self, in_dim, final_dim=512):
        ...
        self.layer1 = ProjectionBlock(in_dim, 64)
        self.layer2 = ProjectionBlock(64, 128)
        self.layer3 = ProjectionBlock(128, 256)
        self.layer4 = ProjectionBlock(256, final_dim)
...
class OutputProjection(nn.Module):
    def __init__(self, in_dim=512, out_dim=7):
        ...
        self.layer2 = ProjectionBlock(256, 128)
        self.layer3 = ProjectionBlock(128, 64)
        self.layer4 = ProjectionBlock(64, out_dim)
